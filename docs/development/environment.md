...
4. Commit message check for a lowercase prefix (`feat`, `fix`, `chore`, `docs`, `refactor`), a single-line message within 75 characters, and no description (`scripts/hooks/commit-msg`).
